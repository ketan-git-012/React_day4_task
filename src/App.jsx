...
class App extends React.Component{
  ...
  switchImage(){
    ...
    let updatedIndex = globals.getNextRoundRobin(this.state.images.length, currentIndex);
    ...
    <>
      <ThemeProvider>
        <ApolloProvider client={client}>
          <Router>
            <div>
              { sessionStorage.getItem('token') ? <Header /> : <Redirect to={{pathname : '/'}} /> }
              <Switch>
                ...
                <Route exact path='/controlledinputs' render={() => <Controlledinputs stylesheet={styles} sports={this.state.sports} sportsOptions={this.state.options} isSports={this.state.isSports} onSelect={this.handleName} onChange={this.handleSports} onClick={this.handleSubmit}/>} />
                <Route exact path="/trainee/:id" render={(props) => <DisplayProfile id={this.props.id} {...props}/> } />
              </Switch>
            </div>
          </Router>
        </ApolloProvider>
